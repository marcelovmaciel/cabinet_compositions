...
A=pathlib.Path('cabinet_dataset/research/followup_bolsonaro_affiliations')
...
CITIES={'RS':['SANANDUVA'],'SP':['PRESIDENTE PRUDENTE'],'PR':['LONDRINA']}
tasks=[]
for uf in ufs:
