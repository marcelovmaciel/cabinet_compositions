...
NAMES=['ADOLFO SACHSIDA','DAMARES ALVES','DAMARES REGINA ALVES','ROGERIO SIMONETTI MARINHO','ROGERIO MARINHO']
...
tasks=[(uf,mun,p) for uf,mun,ids in [('DF','1778',[62,72,69,51,38,56]),('RN','7220',[56,38])] for p in parties if p['id'] in ids]
